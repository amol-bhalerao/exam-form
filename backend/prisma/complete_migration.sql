-- ==============================================================================
-- COMPLETE DATABASE MIGRATION SCRIPT FOR HSC EXAM FORM
-- ==============================================================================
...
-- ==============================================================================
-- MIGRATION 2: Add college UDISE and teachers
-- ==============================================================================

ALTER TABLE `institutes` ADD COLUMN `acceptingApplications` BOOLEAN NOT NULL DEFAULT true,
    ADD COLUMN `city` VARCHAR(100) NULL,
    ADD COLUMN `collegeNo` VARCHAR(20) NOT NULL DEFAULT 'UNKNOWN',
    ADD COLUMN `district` VARCHAR(100) NULL,
    ADD COLUMN `pincode` VARCHAR(10) NULL,
    ADD COLUMN `taluka` VARCHAR(100) NULL,
    ADD COLUMN `udiseNo` VARCHAR(20) NOT NULL DEFAULT 'UNKNOWN';

ALTER TABLE `subjects` ADD COLUMN `category` VARCHAR(30) NOT NULL DEFAULT 'GENERAL';
...
-- ==============================================================================
-- MIGRATION 3: Add institute invites
-- ==============================================================================
...
('20260316185047_init', 'fake', NOW(), '20260316185047_init', '', NULL, NOW(), 1),
('20260319085322_add_college_udise', 'fake', NOW(), '20260319085322_add_college_udise', '', NULL, NOW(), 1),
('20260320133520_add_institute_invites', 'fake', NOW(), '20260320133520_add_institute_invites', '', NULL, NOW(), 1);
