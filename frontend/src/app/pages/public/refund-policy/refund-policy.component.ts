  ...
  template: `
    <div class="public-page">
      <mat-card class="public-card">
        ...
        <section>
          <h2>5. Support</h2>
          <p>For refund-related queries, contact <a href="mailto:mail.hscinfo@gmail.com">mail.hscinfo&#64;gmail.com</a> with the student details, application ID, and payment reference number.</p>
        </section>
      </mat-card>
    </div>
  `,
