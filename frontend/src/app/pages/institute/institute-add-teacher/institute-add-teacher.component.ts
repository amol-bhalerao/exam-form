  ...
  template: `
    <mat-card class="card">
      ...
      <form [formGroup]="form" (ngSubmit)="save()" class="grid">
        ...
        <mat-form-field appearance="outline"><mat-label>Leaving Date</mat-label><input matInput [matDatepicker]="leavingDatePicker" formControlName="leavingDate" /></mat-form-field>
