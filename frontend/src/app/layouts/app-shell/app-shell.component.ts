      ...
      <mat-sidenav 
        ...
        <mat-nav-list class="nav-list">
          ...
          @if (role() === 'SUPER_ADMIN') {
            ...
            <a mat-list-item routerLink="/app/super/institute-dashboard" routerLinkActive="active" class="nav-item" (click)="closeOnMobile()"><mat-icon class="icon">analytics</mat-icon><span class="label">Institute Dashboard</span></a>
          ...
          @if (role() === 'BOARD') {
            ...
            <a mat-list-item routerLink="/app/board/institutes" routerLinkActive="active" class="nav-item" (click)="closeOnMobile()"><mat-icon class="icon">apartment</mat-icon><span class="label">Institute Dashboard</span></a>
          ...
          @if (role() === 'INSTITUTE') {
            ...
            <a mat-list-item routerLink="/app/institute/teachers" routerLinkActive="active" class="nav-item" (click)="closeOnMobile()"><mat-icon class="icon">people</mat-icon><span class="label">Teachers and Staff</span></a>
